...
export default function ProcessSlider({ steps }: { steps: Step[] }) {
  ...
  return (
    <section className="py-40 bg-[#06255d] text-white overflow-hidden">
      ...
      <h2
        className="text-center text-5xl md:text-6xl font-extrabold mb-28 tracking-tight text-[#f5c842]"
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div
          id="process-slider"
          className="flex gap-28 overflow-x-hidden scroll-smooth"
        >
          {steps.map((step, i) => (
            <div
              key={i}
            ...
            >
              ...
              >
                <span className="text-4xl font-bold text-[#06255d]">
                  {i + 1}
                </span>
              </div>
              ...
              <p className="text-white/75 max-w-[260px]">
                {step.description}
              </p>
            </div>
          ))}
